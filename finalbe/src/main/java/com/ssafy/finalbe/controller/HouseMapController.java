...
import com.ssafy.finalbe.model.service.HouseMapService;
...
public class HouseMapController {
	...
	@ApiOperation(value = "시도 정보", response = List.class)
	@GetMapping("/sido")
	...
	@ApiOperation(value = "구군 정보", response = List.class)
	@GetMapping("/gugun")
	...
	@ApiOperation(value = "아파트 목록", response = List.class)
