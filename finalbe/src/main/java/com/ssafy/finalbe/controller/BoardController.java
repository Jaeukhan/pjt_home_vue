...
import com.ssafy.finalbe.model.service.BoardService;
...
public class BoardController {
    ...
    @ApiOperation(value = "게시판 글작성", notes = "새게시글 정보를 입력한다. 그리고 DB입력 성공여부에 따라 'success' 또는 'fail' 문자열을 반환한다.", response = String.class)
    @PostMapping
